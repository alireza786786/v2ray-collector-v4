# -*- coding: utf-8 -*-
"""پیکربندی v4: پیش‌فرض‌ها ← فایل config.yaml ← override متغیر محیطی.
...
def load_config(path: Optional[str] = None) -> Config:
    """بارگیری پیکربندی: پیش‌فرض‌ها ← YAML ← متغیر محیطی (فقط توکن/آیدی)."""
    global CFG
    cfg = Config()
    ...
    # امنیت: توکن و آیدی فقط از env — هرگز از فایل پیکربندی
